...
if __name__ == '__main__':
    t = Excel("D:\wjn\gitee\jzDataMigrate\jz2.xlsm", sheet_name='ads', table_name="ads_t_info_student")
    ...
    r = t.to_datax(DataXReaderType.PGSQL, DataXWriterType.PGSQL, t.table_meta[0], jdbc_conf)
    print(r)
